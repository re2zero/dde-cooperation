...
public:
    ...
    Q_INVOKABLE void doApplyTransfer(const QString &appname, const QString& targetname, const QString& machinename, const int type);
    ...
    Q_INVOKABLE bool doStartShare(const QString& appname, const QString &msg);

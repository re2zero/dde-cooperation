...
Java_com_deepin_cooperation_JniCooperation_nativeVersion(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_deepin_cooperation_JniCooperation_initNative(JNIEnv *env, jobject thiz, jstring ip) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_deepin_cooperation_JniCooperation_stopProjection(JNIEnv *env, jobject thiz,
                                                          jstring nice_name) {
    std::string nickName = jstringToString(env, nice_name);
...
Java_com_deepin_cooperation_JniCooperation_getStatus(JNIEnv *env, jobject thiz) {
    jint result = 0;
    return result;
}

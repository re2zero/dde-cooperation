package com.deepin.assistant.widget
...
import com.deepin.assistant.other.PermissionCallback
import com.deepin.assistant.ui.activity.ImageSelectActivity
import com.deepin.assistant.ui.dialog.InputDialog
import com.deepin.assistant.ui.dialog.MessageDialog
import com.deepin.assistant.ui.dialog.TipsDialog
...
class BrowserView  @JvmOverloads constructor(
    ...
    open class BrowserChromeClient(private val webView: BrowserView) : WebChromeClient() {
        ...
        private fun openSystemFileChooser(activity: BaseActivity, params: FileChooserParams, callback: ValueCallback<Array<Uri>>) {
            ...
            if ((mimeTypes != null) && (mimeTypes.isNotEmpty()) && !TextUtils.isEmpty(mimeTypes[0])) {
                ...
                if (mimeTypes.size == 1) {
                    when (mimeTypes[0]) {
                        "image/*" -> {
                            ImageSelectActivity.start(activity, if (multipleSelect) Int.MAX_VALUE else 1, object :

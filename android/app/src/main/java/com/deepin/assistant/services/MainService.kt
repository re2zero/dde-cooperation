...
//                .sanitizeByFiltering(reconnectIntent);
    ...
    companion object {
        ...
        const val ACTION_START: String = "com.deepin.assistant.ACTION_START"
        const val ACTION_STOP: String = "com.deepin.assistant.ACTION_STOP"
        const val ACTION_CONNECT_REVERSE: String = "com.deepin.assistant.ACTION_CONNECT_REVERSE"
        const val ACTION_CONNECT_REPEATER: String = "com.deepin.assistant.ACTION_CONNECT_REPEATER"
        const val EXTRA_REQUEST_ID: String = "com.deepin.assistant.EXTRA_REQUEST_ID"
        const val EXTRA_REQUEST_SUCCESS: String = "com.deepin.assistant.EXTRA_REQUEST_SUCCESS"
        const val EXTRA_HOST: String = "com.deepin.assistant.EXTRA_HOST"
        const val EXTRA_PORT: String = "com.deepin.assistant.EXTRA_PORT"
        const val EXTRA_REPEATER_ID: String = "com.deepin.assistant.EXTRA_REPEATER_ID"
        const val EXTRA_RECONNECT_TRIES: String = "com.deepin.assistant.EXTRA_RECONNECT_TRIES"
        const val EXTRA_ACCESS_KEY: String = "com.deepin.assistant.EXTRA_ACCESS_KEY"
        const val EXTRA_PASSWORD: String = "com.deepin.assistant.EXTRA_PASSWORD"
        const val EXTRA_VIEW_ONLY: String = "com.deepin.assistant.EXTRA_VIEW_ONLY"
        const val EXTRA_SHOW_POINTERS: String = "com.deepin.assistant.EXTRA_SHOW_POINTERS"
        const val EXTRA_SCALING: String = "com.deepin.assistant.EXTRA_SCALING"

        /**
         * Only used on Android 12 and earlier.
         */
        const val EXTRA_FILE_TRANSFER: String = "com.deepin.assistant.EXTRA_FILE_TRANSFER"

        /**
         * Only used on Android 10 and later.
         */
        const val EXTRA_FALLBACK_SCREEN_CAPTURE: String =
            "com.deepin.assistant.EXTRA_FALLBACK_SCREEN_CAPTURE"

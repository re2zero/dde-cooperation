...
import com.deepin.assistant.services.MainService.Companion.vncNewFramebuffer
import com.deepin.assistant.services.MainService.Companion.vncUpdateFramebuffer
        ...
        override fun onInputPointerEvent(buttonMask: Int, x: Int, y: Int, client: Long) {
            ...
            try {
                val inputContext = instance!!.mInputContexts[client]
                    ?: throw IllegalStateException("Client $client was not added or is already removed")
